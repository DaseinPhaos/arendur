...
mod test_projective {
    ...
    fn test_perspec_proj() {
        ...
        let point = Point3f::new(0. as Float, 0. as Float, 999.99999 as Float);
        let point_t = Point3f::new(0. as Float, 0. as Float, 1.0 as Float);
        ...
        let pixel = Point3f::new(400. as Float, 300. as Float, 0.0 as Float);
        let pixel_v = projinfo.raster_view.transform_point(pixel).to_vec().normalize();
        assert_ulps_eq!(pixel_v, Vector3f::new(0. as Float, 0. as Float, 1.0 as Float));
